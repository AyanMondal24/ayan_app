<div class="thank-you-container">
    ...
    <div class="box">
        ...
        <?php if(!empty($order->payment_method) && $order->payment_method !== 'Cash On Delivery'){ ?>
            <p>Your transaction id is <?= $order->transaction_id ?></p>
        ...
        <a href="<?= base_url('Shop') ?>" class="text-underline">
            Shop More
        </a>
    </div>
    <?php } else { ?>
        <div class="box">No order found</div>
    <?php } ?>
</div>
